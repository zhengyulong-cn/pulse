...
import { LwcPluginPulsePaneRenderer } from './pane-renderer';
...
export class LwcPluginPulsePaneView implements IPrimitivePaneView {
	_source: LwcPluginPulseDataSource;
	_p1: ViewPoint = { x: null, y: null };
	_p2: ViewPoint = { x: null, y: null };

	constructor(source: LwcPluginPulseDataSource) {
		this._source = source;
	}
	...
	renderer() {
		return new LwcPluginPulsePaneRenderer(
			this._p1,
			this._p2,
