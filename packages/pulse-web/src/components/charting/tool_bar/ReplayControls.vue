...
<template>
  <div
    class="absolute bottom-5 left-1/2 z-10 flex -translate-x-1/2 items-center gap-1 rounded-lg border border-slate-200 bg-white p-1.5 shadow-lg"
  >
    <button
      type="button"
    ...
    <select
      :value="speed"
      class="rounded border-0 bg-slate-50 px-2 py-1 text-xs text-slate-600 outline-none"
