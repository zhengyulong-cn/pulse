    ...
    <el-form label-position="top" @submit.prevent="save">
      ...
      <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
        <el-form-item label="账户名称" required
          ><el-input v-model="form.name" placeholder="例如：主账户"
        /></el-form-item>
        <el-form-item label="交易账户" required
          ><el-input v-model="form.account" placeholder="例如：12345678"
        /></el-form-item>
        <el-form-item label="货币" required
          ><el-select
            ...
            ><el-option label="人民币（CNY）" value="CNY" /><el-option
              label="美元（USD）"
              value="USD" /><el-option label="欧元（EUR）" value="EUR" /></el-select
        ></el-form-item>
      </div>
