...
@router.post("/sync", response_model=MarketInstrumentSyncJobRead, status_code=status.HTTP_202_ACCEPTED)
...
@router.get("/sync/{job_id}", response_model=MarketInstrumentSyncJobRead)
